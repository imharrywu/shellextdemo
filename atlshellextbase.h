...
#define MAKEWINVER(major, minor)  MAKELONG(minor, major)
...
public:
   ...
   #define CFSTR_LOGICALPERFORMEDDROPEFFECT    TEXT("Logical Performed DropEffect")
      ...
      m_CFSTR_FILEDESCRIPTORA            = (CLIPFORMAT) ::RegisterClipboardFormat(CFSTR_FILEDESCRIPTORA);
      m_CFSTR_FILEDESCRIPTORW            = (CLIPFORMAT) ::RegisterClipboardFormat(CFSTR_FILEDESCRIPTORW);
      ...
      m_dwWinVer = MAKEWINVER(m_WinVer.dwMajorVersion, m_WinVer.dwMinorVersion);
   ...
   CLIPFORMAT m_CFSTR_FILEDESCRIPTORA;
   CLIPFORMAT m_CFSTR_FILEDESCRIPTORW;
